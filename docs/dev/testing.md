...
- CLI E2E tests: `htmlslide new`, `htmlslide check --json`, `htmlslide export --pdf --deckpkg`, `htmlslide mcp --list-tools --json`, `htmlslide mcp <project> --status --json`, MCP stdio client smoke, `htmlslide package`, `htmlslide doctor`.
